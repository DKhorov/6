...
export const JsIcon = () => (
  <svg width="20" height="20" viewBox="0 0 630 630" xmlns="http://www.w3.org/2000/svg">
...
<rect width="122.48" height="122.88" fill="white"/>
</clipPath>
</defs>
</svg>
...
<path d="M52 100.1V107.9H104V100.1H52ZM156 100.1V107.9H208V100.1H156ZM104 178.1V185.9H156V178.1H104ZM78 204.1V211.9H104V204.1H78ZM156 204.1V211.9H182V204.1H156Z" fill="#80D05D"/>
<path d="M52 55.8999V104H104V55.8999H52ZM156 55.8999V104H208V55.8999H156ZM104 107.9V133.9H78V208H104V182H156V208H182V133.9H156V107.9H104Z" fill="black"/>
</g>
<defs>
...
<line x1="34" y1="18" x2="22" y2="18" stroke="#FFCC00" stroke-width="2"/>
<line x1="19" y1="22" x2="7" y2="22" stroke="#FFCC00" stroke-width="2"/>
<line x1="19" y1="22" x2="7" y2="22" stroke="#FFCC00" stroke-width="2"/>
<defs>
<linearGradient id="paint0_linear_25_32" x1="26" y1="1.5" x2="10" y2="37.5" gradientUnits="userSpaceOnUse">
<stop stop-color="#F6A800"/>
<stop offset="1" stop-color="#CC9910"/>
</linearGradient>
</defs>
</svg>
...
<path d="M99.3152 142.343C100.927 140.751 103.056 139.787 105.319 139.624C106.726 139.529 108.137 139.734 109.459 140.226C110.753 140.732 111.928 141.499 112.909 142.481C114.554 144.111 115.547 146.283 115.704 148.591C115.752 149.397 115.705 150.206 115.566 151.001C115.175 153.27 113.975 155.322 112.187 156.777C110.398 158.233 108.143 158.993 105.836 158.919C104.483 158.894 103.149 158.589 101.92 158.023C99.7152 157.012 97.9768 155.203 97.0552 152.963C96.7692 152.261 96.5666 151.527 96.4515 150.777C96.3321 150.032 96.2974 149.276 96.348 148.522C96.4788 147.328 96.8113 146.164 97.3313 145.08C97.7825 144.057 98.447 143.142 99.2807 142.395L99.3152 142.343ZM113.392 124.718C113.047 132.963 99.0564 132.98 98.7286 124.718C97.314 110.587 93.6913 74.1321 93.812 60.8617C93.9328 56.7652 97.2623 54.3383 101.679 53.4089C104.526 52.8445 107.457 52.8445 110.304 53.4089C114.807 54.3728 118.326 56.8513 118.326 61.051V61.4641L113.392 124.718Z" fill="white"/>
</g>
<defs>
...
export const KotlinIcon = () => (
  ...
  >
    <g>
      ...
      <polygon id="XMLID_2_" fill="url(#XMLID_3_)" points="0,60 30.1,29.9 60,60"/>
      ...
      <polygon fill="url(#SVGID_2_)" points="30.1,0 0,31.7 0,60 30.1,29.9 60,0"/>
    </g>
  </svg>
);
